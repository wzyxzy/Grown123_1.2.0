 ...
 * Original file: E:\\work\\workspace_eclipse\\Grown123_1.0.3\\src\\com\\pndoo\\grown123_new\\service\\IMusicPlayerService.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements com.pndoo.grown123_new.service.IMusicPlayerService
{
private static final java.lang.String DESCRIPTOR = "com.pndoo.grown123_new.service.IMusicPlayerService";
...
/**
 * Cast an IBinder object into an com.pndoo.grown123_new.service.IMusicPlayerService interface,
 * generating a proxy if needed.
 */
public static com.pndoo.grown123_new.service.IMusicPlayerService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.pndoo.grown123_new.service.IMusicPlayerService))) {
return ((com.pndoo.grown123_new.service.IMusicPlayerService)iin);
}
return new com.pndoo.grown123_new.service.IMusicPlayerService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.pndoo.grown123_new.service.IMusicPlayerService
{
...
static final int TRANSACTION_openAudio = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_seeKTo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getAudioName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getAllAudio = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
...
static final int TRANSACTION_getCurrentPositon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
...
static final int TRANSACTION_pre = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
}
