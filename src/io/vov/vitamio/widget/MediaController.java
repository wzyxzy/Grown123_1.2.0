...
import com.pndoo.grown123_new.util.ScreenObserver;
import com.pndoo.grown123_new.util.ScreenObserver.observerScreenStateUpdateListener;
...
public class MediaController extends FrameLayout {
	...
	private void initControllerView(View v) {
		...
		mBackButton = (ImageButton) v.findViewById(getResources()
				.getIdentifier("mediacontroller_play_back", "id",
						mContext.getPackageName()));
	...
	public boolean dispatchKeyEvent(KeyEvent event) {
		...
		if (event.getRepeatCount() == 0
				&& (keyCode == KeyEvent.KEYCODE_HEADSETHOOK
						|| keyCode == KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE || keyCode == KeyEvent.KEYCODE_SPACE||keyCode == KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE)) {
			doPauseResume();
			show(sDefaultTimeout);
			if (mPauseButton != null)
				mPauseButton.requestFocus();
