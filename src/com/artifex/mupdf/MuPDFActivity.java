...
import com.pndoo.grown123_new.BaseActivity;
...
public class MuPDFActivity extends BaseActivity {
	...
	public void createUI(Bundle savedInstanceState) {
		...
		mFilenameView.setText(StringUtil.subString(mFileName, 8, "..."));
		...
		int tiled_background = getResources().getIdentifier("tiled_background",
				"drawable", getPackageName());
		layout.setBackgroundResource(tiled_background);
	...
	public void onDestroy() {
		if (core != null)
			core.onDestroy();
		core = null;
		ActivityUtils.deleteBookFormSD(ActivityUtils.getSDPath(bookId).getAbsolutePath()
				+ "/" + fileName);
		super.onDestroy();
	}
