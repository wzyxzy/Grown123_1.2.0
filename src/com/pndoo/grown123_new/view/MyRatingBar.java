...
//                        BigDecimal b2 = new BigDecimal(Integer.toString(fint));//浮点数的小数部分
...
//                        }
    ...
    public void setStar(float rating) {
        ...
        this.starStep = rating;//浮点数的整数部分
        int fint = (int) rating;
        BigDecimal b1 = new BigDecimal(Float.toString(rating));
        BigDecimal b2 = new BigDecimal(Integer.toString(fint));//浮点数的小数部分
        float fPoint = b1.subtract(b2).floatValue();//设置选中的星星
