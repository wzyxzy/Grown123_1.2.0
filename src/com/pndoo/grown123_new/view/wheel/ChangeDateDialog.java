...
public class ChangeDateDialog extends Dialog implements android.view.View.OnClickListener,OnWheelChangedListener{
...
//		wvProvince.setCyclic(true);//设置内容循环
	...
	public void initCitys(String[] citys) {
		if (citys != null) {
			...
			String[] city = mCitisDatasMap.get("2010");
			arrCitys.clear();
...
////////////////////////////////////////////////////华丽的分界线	
	private void initJsonData() {
		try {
			...
			InputStream is = context.getAssets().open("date.json");
			int len = -1;
