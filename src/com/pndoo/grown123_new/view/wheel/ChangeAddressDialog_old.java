...
public class ChangeAddressDialog_old extends Dialog implements View.OnClickListener,OnWheelChangedListener{
	...
	public ChangeAddressDialog_old(Context context) {
