package com.pndoo.grown123_new.download2.utils;
...
import com.pndoo.grown123_new.download2.observer.DateObserverable;
import com.pndoo.grown123_new.download2.thread.DownloadThread1;
...
public class DownloadManager {
	...
	public boolean isDownloading(AttachOne attach) {
		...
		if (docInfos != null) {
			for (DocInfo docInfo : docInfos) {
				if ((attach.getAttachOneSaveName() + "." + attach.getAttachOneType()).equals(docInfo.getName())) {
					return true;
				}
			}
		}
	...
	public boolean isDownloading(AttachTwo attachTwo) {
		...
		if (docInfos != null) {
			for (DocInfo docInfo : docInfos) {
				if ((attachTwo.getAttachTwoSaveName() + "." + attachTwo.getAttachTwoType()).equals(docInfo.getName())) {
					return true;
				}
			}
		}
