...
import com.pndoo.grown123_new.DianPlayActivity;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.bg.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				org.xutils.http.RequestParams params = new org.xutils.http.RequestParams(Preferences.GET_VIDEO_URL);
		...
		holder.time.setText(TimeFormate.formatetime(Integer.parseInt(bean.getDuration())));
...
//                }
		...
		if(selectedMap.containsKey(position)){
			holder.show.setImageResource(R.drawable.show2);
			...
			holder.show.setImageResource(R.drawable.show);
