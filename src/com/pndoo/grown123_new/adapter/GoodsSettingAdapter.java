...
import com.pndoo.grown123_new.dto.base.GoodsSettingBean;
...
public class GoodsSettingAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(bean.getStatus() == 1)
                    return;
                org.xutils.http.RequestParams params = new org.xutils.http.RequestParams(Preferences.ZHIBO_GOODS_SEND);
        ...
        holder.btn_cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(bean.getStatus() == 0)
                    return;
                org.xutils.http.RequestParams params = new org.xutils.http.RequestParams(Preferences.ZHIBO_GOODS_CANCEL);
                params.addQueryStringParameter("courseId", courseId+"");
                params.addQueryStringParameter("goodId", bean.getGoodId()+"");
    ...
    private void showView(int status,Button btn_send,Button btn_cancel) {
        btn_send.setBackgroundResource(status == 0?R.drawable.btn:R.drawable.kuang2);
        btn_cancel.setBackgroundResource(status == 1?R.drawable.btn:R.drawable.kuang2);
