...
public class ReaderComment implements Serializable {
	...
	@ComplexSerializableType(clazz = ReaderMainContent.class)
	public List<ReaderMainContent> getMainContents() {
		return mainContents;
	}
	@ComplexSerializableType(clazz = ReaderMainContent.class)
	public void setMainContents(List<ReaderMainContent> mainContents) {
