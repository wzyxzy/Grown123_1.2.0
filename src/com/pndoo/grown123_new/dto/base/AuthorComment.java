...
public class AuthorComment implements Serializable {
	...
	@ComplexSerializableType(clazz = AuthorMainContent.class)
	public List<AuthorMainContent> getMainContents() {
		return mainContents;
	}
	@ComplexSerializableType(clazz = AuthorMainContent.class)
	public void setMainContents(List<AuthorMainContent> mainContents) {
