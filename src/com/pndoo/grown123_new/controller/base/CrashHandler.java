...
//		saveCrashInfo2File(ex);
	...
	public void collectDeviceInfo(Context ctx) {
		try {
			...
			if (pi != null) {
				...
				String userName = UserUtil.getInstance(mContext).getUserName();
				infos.put("userName", userName == null ? "null" : userName);
			}
	...
	public static File getSDPath() {
		...
		if (!Environment.MEDIA_MOUNTED.equals(storageState)) {
			...
			String path = sdPath.getPath() + "/error";
