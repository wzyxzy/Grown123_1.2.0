...
import com.pndoo.grown123_new.adapter.YuGaoAdapter;
...
import com.pndoo.grown123_new.dto.base.YuGaoChildBean;
...
public class YuGaoActivity extends BaseActivity {
    ...
    private void buycourse(String courseIds, String pid) {
        org.xutils.http.RequestParams params = new org.xutils.http.RequestParams(Preferences.SUBMIT_COURSE_ORDER);
